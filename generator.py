...
def train(gpu, args):
    ...
    config['inference']['eval_num'] = len(train_dataset)
    ...
    for bi, val_idx in enumerate(val_list):
        ...
        #@ SAVE LOCATIONS
        save_dir = os.path.join(config['saver']['exp_dir'], class_name, instance_name)
        os.makedirs(save_dir, exist_ok=True)

        n_frames = inference_config['train_batch_size']
        jpg_path = f'{save_dir}/eval_results.jpg'
        gif_path = f'{save_dir}/eval_results.gif'
